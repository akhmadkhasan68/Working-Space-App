			...
			<div class="card">
				...
				<div class="card-header d-flex align-items-center">
					<div class="d-flex align-items-center">
						<a href="#">
							<img src="<?= base_url()?>assets/admin/img/theme/team-1.jpg" class="avatar">
						</a>
						<div class="mx-3">
				...
				<div class="card-body">
					...
					<img alt="Image placeholder" src="<?= base_url()?>assets/admin/img/theme/img-1-1000x600.jpg"
							...
							<div class="d-flex align-items-center justify-content-sm-end">
								<div class="avatar-group">
									<a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
										...
										<img alt="Image placeholder" src="<?= base_url()?>assets/admin/img/theme/team-1.jpg" class="">
									</a>
									<a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
					...
					<div class="mb-1">
						<div class="media media-comment">
							<img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle"
								src="<?= base_url()?>assets/admin/img/theme/team-1.jpg">
						...
						<div class="media media-comment">
							<img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle"
								src="<?= base_url()?>assets/admin/img/theme/team-2.jpg">
							<div class="media-body">
								<div class="media-comment-text">
						...
						<div class="media align-items-center">
							<img alt="Image placeholder" class="avatar avatar-lg rounded-circle mr-4"
								src="<?= base_url()?>assets/admin/img/theme/team-3.jpg">
							<div class="media-body">
								<form>
											...
											<div class="media align-items-center">
												<a href="#" class="avatar rounded-circle mr-3">
													<img alt="Image placeholder"
														src="<?= base_url()?>assets/admin/img/theme/bootstrap.jpg">
												</a>
												<div class="media-body">
										...
										<td>
											<div class="avatar-group">
												...
												<a href="#" class="avatar avatar-sm rounded-circle"
													...
													<img alt="Image placeholder"
														src="<?= base_url()?>assets/admin/img/theme/team-4.jpg">
												</a>
											</div>
										</td>
										<td>
									...
									<tr>
										<th scope="row">
											<div class="media align-items-center">
												<a href="#" class="avatar rounded-circle mr-3">
													<img alt="Image placeholder"
														src="<?= base_url()?>assets/admin/img/theme/angular.jpg">
												</a>
												<div class="media-body">
									...
									<tr>
										<th scope="row">
											<div class="media align-items-center">
												<a href="#" class="avatar rounded-circle mr-3">
													<img alt="Image placeholder"
														src="<?= base_url()?>assets/admin/img/theme/sketch.jpg">
												</a>
												<div class="media-body">
				...
				<div class="card bg-gradient-danger">
					...
					<div class="card-body">
						<div class="row justify-content-between align-items-center">
							<div class="col">
								<img src="<?= base_url()?>assets/admin/img/icons/cards/bitcoin.png" alt="Image placeholder" />
							</div>
							<div class="col-auto">
