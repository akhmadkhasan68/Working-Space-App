		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-12 mx-auto">
				...
				<div class="row justify-content-start">
					<a href="<?php echo site_url('guest/transaction')?>" class="btn btn-warning ml-3">Reservasi &nbsp;<i class="fa fa-ticket"></i></button>
				</div>
			</div>
		</div>
					...
					<div class="card-body">
						<div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="tabs-icons-text-4" role="tabpanel"
								...
								<div class="row align-items-center justify-content-md-between">
									<div class="col-md-12">
										<span class="badge badge-pill ml-2 mt-2" style="background-color: #1a0dab;color:white;">OVO</span>
